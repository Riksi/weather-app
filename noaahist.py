...
def main(args, update_stations=False):
    ...
    if update_stations or not os.path.exists(stns_path) or (time.time() - os.path.getmtime(stns_path)) > 180 * 24 * 60 * 60:
        stns_url = 'https://raw.githubusercontent.com/stewartwatts/noaahist/master/static/ISH-HISTORY.TXT' #'ftp://ftp.ncdc.noaa.gov/pub/data/inventories/ISH-HISTORY.TXT'
